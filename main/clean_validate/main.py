...
to_run = 'clean_validate'
run_type = 'single_file'
doc_types = doc_types_clean_validate
    ...
    if run_type == 'es':
        ...
        for doc_type in doc_types:
            ...
            if not os.path.exists(os.path.join(doc_path, doc_type)):
                ...
                #     add_path = '/spilt/*'
                os.system('hadoop fs -getmerge  /user/dataom/20160801-validate-cleaner/' + WANT_TO_GET + '/success ' + doc_path + os.sep + doc_type)  #
